...
public class InstructionSet {
    ...
    public static final int OP_ADC_IND_IY = 0x71;
    ...
    public static final int OP_LDA_IND_IY = 0xB1;
    ...
    public static final int OP_AND_IND_IY = 0x31;
    ...
    public static final int OP_ORA_IND_IY = 0x11;
    ...
    public static final int OP_EOR_IND_IY = 0x51;
    ...
    public static final int OP_SBC_IND_IY = 0xF1;
    ...
    public static final int OP_RTI = 0x40;
    ...
    public static final int[] instructionSet = {OP_BRK,
                                                ...
                                                OP_ADC_Z, OP_ADC_I, OP_ADC_ABS, OP_ADC_ABS_IX, OP_ADC_ABS_IY, OP_ADC_Z_IX, OP_ADC_IND_IX, OP_ADC_IND_IY,
                                                OP_SBC_I, OP_SBC_Z, OP_SBC_Z_IX, OP_SBC_ABS, OP_SBC_ABS_IX, OP_SBC_ABS_IY, OP_SBC_IND_IX, OP_SBC_IND_IY,
                                                OP_LDA_Z, OP_LDA_I, OP_LDA_ABS, OP_LDA_Z_IX, OP_LDA_ABS_IY, OP_LDA_IND_IX, OP_LDA_IND_IY, OP_LDA_ABS_IX,
                                                ...
                                                OP_AND_I, OP_AND_IND_IX, OP_AND_IND_IY, OP_AND_Z, OP_AND_Z_IX, OP_AND_ABS_IX, OP_AND_ABS_IY, OP_AND_ABS, OP_ORA_I, OP_ORA_Z, OP_ORA_Z_IX, OP_ORA_ABS, OP_ORA_ABS_IX, OP_ORA_ABS_IY, OP_ORA_IND_IX, OP_ORA_IND_IY, OP_EOR_I, OP_EOR_Z, OP_EOR_Z_IX, OP_EOR_ABS, OP_EOR_ABS_IX, OP_EOR_ABS_IY, OP_EOR_IND_IX, OP_EOR_IND_IY, OP_BIT_Z, OP_BIT_ABS,
    ...
    public static String getOpCodeName(int opCode){
        switch (opCode){
            ...
            case OP_ADC_IND_IY: return "ADC (Indirect, Y)";
            ...
            case OP_LDA_IND_IY: return "LDA (Indirect, Y)";
            ...
            case OP_AND_IND_IY: return "AND (Indirect, Y)";
            ...
            case OP_ORA_IND_IY: return "OR (Indirect, Y)";
            ...
            case OP_EOR_IND_IX: return "EOR (Indirect, X)";
            case OP_EOR_IND_IY: return "EOR (Indirect, Y)";
            ...
            case OP_SBC_IND_IY: return "SBC (Indirect, Y)";
